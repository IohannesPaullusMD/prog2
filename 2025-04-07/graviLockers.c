...
{
	if (
		strcmp(L->owner.studID, studID) != 0
		|| (L->totWeight + newItem.weight) > WEIGHTLIMIT
	) { return; }
	...
	ItemNode *newNode = calloc(1, sizeof(ItemNode));
